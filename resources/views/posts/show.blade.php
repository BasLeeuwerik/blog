            ...
            <div class="p-6 flex space-x-2">
                ...
                <div class="flex-1">
                    <div class="flex justify-between items-center">
                        <div>
                            <b><span class="text-gray-800">{{ $post->user->name }}</span></b>
                            <small
                                class="ml-2 text-sm text-gray-600">{{ $post->created_at->format('j M Y, H:i') }}</small>
            ...
            <div class="p-6">
                ...
                <div class="mt-6">
                    ...
                    @foreach ($post->comments->sortByDesc('created_at') as $comment)
                        <div class="bg-gray-100 p-4 mt-4 mb-4 rounded-md"> <!-- Updated margin and padding classes -->
                            <b><span class="text-gray-800">{{ $comment->user->name }}</span></b>
                            <small
                                class="ml-2 text-sm text-gray-600">{{ $comment->created_at->format('j M Y, H:i') }}</small>
